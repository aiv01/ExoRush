...
public class EnemyMasterRagdoll : MonoBehaviour
{
    public GameObject ragdollPrefab;
    Vector3 DeathLaunchForce = new Vector3(0,10, 400000);
    public float DeathForceMultiplier = 1f;
    ...
    public void Replace()
    {
        ...
        //TestForce
        //ragdollInstance.GetComponent<Rigidbody>().AddForce(DeathLaunchForce * DeathForceMultiplier);
